...
1. Archived it in a routine GitHub cleanup — swept up as cruft, no
   ceremony.
2. It died as collateral, not a decision. *(the casualness is the point)*
3. Past life was building, not writing — Nikola (2014), Hakyll (2017),
   theme churn, Cloud Build / Travis / Docker / Nix pipelines.
4. One new post in the whole git era — [How I Read](/posts/how-i-read)
   (2018).
5. I'm prolific when something has me; this hadn't, for years.
6. So when I tidied, it went. Clean, no guilt. *(anchor: last activity a
   version-cap bump in 2020, then silence)*
...
5. Then the wanting — I started wanting to show the work to someone.
6. Not to prove anything; to find out whether it's useful to anyone
   besides me.
7. The blog is the easiest way to put it where people can find it (reach,
   not engagement); social never clicked, so I'm starting here.
8. Reopened the blog — May 2026, AstroPaper, one
   [PR #49](https://github.com/alunduil/blog.alunduil.com/pull/49).
   *(one line — the why lands in scene 4)*
...
4. Each piece wants writing up; the blog is where it lands.
5. Worktrees (#254), homelab as a system (#251), the AI-coding bill
...
## 4. The tool was never the lever — *the point (the turn)*

1. None of it came from a better tool.
2. I'd swapped generators before — Nikola for Hakyll — and the blog
   stayed just as silent.
3. A new generator never once started the writing.
4. AstroPaper only unlocked the door; the wanting walked me through.
...
5. But this machine points outward — the old ones were places to hide;
   this one pushes the work out where someone might read it.
6. Same shape, opposite purpose.
7. Hope is not a strategy (enough production systems to have the line
   reflexive). I'm going to hope anyway.
8. The post shipped, the queue is real — this time it points at sharing,
   not hiding.
