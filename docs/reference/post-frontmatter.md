...
and the weekday, read in the post's own `timezone`. No frontmatter field
states a post's subject, so nothing checks that a Tuesday post is tech and
a Sunday post personal.
